...
class FlightEvent(BaseModel):
    ...
    booking_id: str | None = Field(description="Booking Reference ID, e.g LMN-012-STU")
...
class HotelEvent(BaseModel):
    ...
    booking_required: bool = Field(default=True)
    price: str | None = Field(description="Total hotel price including all nights")
    booking_id: str | None = Field(description="Booking Reference ID, e.g ABCD12345678")
